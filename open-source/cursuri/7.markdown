---
title: "Artefact, CI, testare"
permalink: /open-source/cursuri/7/
layout: shower
...
- să se creeze o logică de separare environment de dezvoltare şi producţie in Docker Swarm, în funcţie de branch-ul pe care lucrăm în GitLab şi destinaţia în care vrem să facem release

## Sugestii proiect MLMOS
Sugestii:
